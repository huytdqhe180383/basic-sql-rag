"""Legacy demo-schema question rules and retrieval-ranking helpers.

This module exists to keep the original e-commerce demo and old imports working
while the metadata-grounded linker becomes the primary path. Keep it generic or
demo-only; do not add Spider2-Snow database-specific rules here.
"""
