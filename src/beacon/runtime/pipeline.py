...
from beacon.linking.retrieval import build_prompt, retrieve_context
from beacon.runtime.feedback_examples import candidate_from_attempt, save_candidate_example
from beacon.runtime.pipeline_tools import (
    MAX_SQL_ATTEMPTS,
    call_llm,
...
from beacon.runtime.retry import classify_retry_need, format_retry_context_update, repair_linked_context
from beacon.runtime.sql import SqlValidationError, clean_sql, format_results, run_query, validate_sql
...
def main() -> None:
    ...
    if not question:
        try:
            ...
            print("Please provide a question, for example: python -m beacon.pipeline \"How many orders?\"")
            return
