...
from beacon.indexing.profiles import build_example_docs, build_schema_docs, load_json, load_semantic_model
from beacon.linking.compatibility import (
    assess_coverage,
...
# --- Legacy LlamaIndex path -------------------------------------------------
#
# These helpers are kept for the original demo retrieval workflow and old tests.
# The active pipeline enters through retrieve_context(), which uses link_schema()
# and the local metadata/vector linker below. Do not add Spider2-Snow-specific
# rules or new primary pipeline behavior to this section.
...
# --- Active metadata-grounded retrieval path --------------------------------
